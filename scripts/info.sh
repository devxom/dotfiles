...
# original script: github.com/windelicato
...
pkgnum=$(rpm -qa | wc -l)
birthd=$(LC_TIME="en_DK" rpm -qia |grep "Install Date"|awk '{print $3}'|uniq |sort -r|tail -n 1)

gitdir="github.com/devxom"
myblog="twitter.com/devxom"
